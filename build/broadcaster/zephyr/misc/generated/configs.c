...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 3584);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ID_MAX, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_FRAME_SPACE_UPDATE_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CHANNEL_SOUNDING_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_EXTENDED_FEAT_SET_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SHORTER_CONNECTION_INTERVALS_SUPPORT, 1);
